export { workouts, EXERCISE_INDEX, EX_SESSION_INDEX, initWorkouts, state, setState, exerciseLibrary, programDefaults, defaultWorkoutsData, resolveInstance, rebuildIndexes } from './workouts.js';
...
export { persist, loadState, normalize, validate, sanitizeSessions } from './persistence.js';